...
library(ggbio, quietly = T); library(rtracklayer, quietly = T); library(GenomicFeatures, quietly = T)
gff <- import('maxGenes100/splicing_variants.gff3')
autoplot(split(gff[seqnames(gff) == 'Y' & gff$type == 'exon'], gff[seqnames(gff) == 'Y' & gff$type == 'exon']$transcript_id))
```
