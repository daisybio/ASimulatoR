...
### Details
 ...
 Several optional parameters can be passed to this function to adjust the simulation. These parameters are passed to `simulate_experiment` from our ![custom polyester R package](https://github.com/biomedbigdata/polyester).
